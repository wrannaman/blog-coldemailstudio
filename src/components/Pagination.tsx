...
export default function Pagination({ current, pages, link }: Props) {
  ...
  return (
    <nav className="pt-10 border-t border-gray-200 px-4 flex items-center justify-between sm:px-0">
          ...
          return (
            <>
              {it.excerpt ? (
                ...
                <Link href={href} as={link.as(it.page)}>
                  <a className="-mt-px border-t-2 border-transparent pt-4 px-4 inline-flex items-center text-sm leading-5 font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-400 transition ease-in-out duration-150">
                    {it.page}
                  </a>
                </Link>
              )}
